...
from .local_video_nodes import (
    NODE_CLASS_MAPPINGS as LOCAL_VIDEO_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as LOCAL_VIDEO_NODE_DISPLAY_NAME_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **LOCAL_VIDEO_NODE_CLASS_MAPPINGS,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    **CORE_NODE_DISPLAY_NAME_MAPPINGS,
    **EXTRA_NODE_DISPLAY_NAME_MAPPINGS,
    **LOCAL_VIDEO_NODE_DISPLAY_NAME_MAPPINGS,
}
